...
for añoEnCurso in range(añoInicial, añoFinal+1):
  ...
  urlPeticion = "https://opendata.aemet.es/opendata/api/valores/climatologicos/diarios/datos/fechaini/" + str(añoEnCurso) + "-05-01T00%3A00%3A00UTC/fechafin/" + str(añoEnCurso) + "-10-05T00%3A00%3A00UTC/estacion/" + estacion
  print(urlPeticion)
